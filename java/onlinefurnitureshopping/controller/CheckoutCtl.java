...
import onlinefurnitureshopping.model.InvoiceModel;
import onlinefurnitureshopping.model.InvoiceModelInt;
...
public class CheckoutCtl extends BaseCtl {
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        ...
        if (OP_CONFIRM_PAYMENT.equalsIgnoreCase(op)) {
              ...
              InvoiceModelInt model=new InvoiceModel();
              InvoiceBean bean=new InvoiceBean();
              HttpSession session=request.getSession();
              UserBean uBean=(UserBean)session.getAttribute("user");
              
              CartModelInt cModel=new CartModel();
              CartBean cBean=null;
